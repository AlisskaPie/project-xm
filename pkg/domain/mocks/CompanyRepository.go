...
func (_m *CompanyRepository) Create(ctx context.Context, c domain.CreateCompany) error {
	ret := _m.Called(ctx, c)
...
func (_m *CompanyRepository) Patch(ctx context.Context, id uuid.UUID, c domain.PatchCompany) (domain.Company, error) {
